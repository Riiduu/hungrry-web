...
const DisplayRecipe = (props: any) => {
    return (
        <div className="bg-[var(--col-primary)] w-56 min-w-56 p-1 rounded-xl cursor-pointer hover:shadow-md">
            <div className=" text-center">
                ...
                {/** Food Name */}
                <h1 className="mt-3 text-lg font-medium text-white">{props.name}</h1>
                <div className="flex justify-between w-fit space-x-2 mx-auto">
                    {/** Calories */}
                    {/** TODO: Come up with better color combinations */}
                    <h1 className="text-green-500">{props.calories} <span className="text-white font-bold">Calories</span></h1>
                    {/** Spacer */}
                    <h1>|</h1>
                    {/** Ingredient count */}
                    <h1 className="text-green-500">{props.ingredientsCount} <span className="text-white font-bold">Ingredients</span></h1>
                </div>
                {/** Source */}
