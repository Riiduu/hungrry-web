...
const Navbar = () => {
    return (
        <div className="bg-[var(--col-primary)] flex flex-col w-full p-5 sm:justify-between">
            ...
            <form className="flex flex-col w-full pt-5 sm:hidden">
                <div className="flex flex-row items-center bg-white pl-3 rounded-lg">
                    <SearchIcon />
                    <input className="p-2 rounded-lg w-full focus:outline-none" onSubmit={() => console.log("Your mother")} placeholder="List ingredients" type="text"/>
                </div>
            </form>
        </div>
    )
